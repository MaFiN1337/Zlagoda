...
<div class="container-fluid">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form
                            action="${pageContext.request.contextPath}/controller/manager/categories/searchByName"
                            method="POST" role="form">

                        <div class="form-group">
                            <label for="name"><fmt:message
                                    key="zlagoda.category.searchByName" bundle="${rb}" /></label> <input
    ...
    <div class="row-fluid" align="center">
        <h2>
            <fmt:message key="zlagoda.categories" bundle="${rb}" />
        </h2>
    </div>
