...
<button class="btn"
        onclick="location.href='${pageContext.request.contextPath}/controller/cashier/customerCards/addCustomerCard';">
...
<div id="searchCustomerCardSurname" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="${pageContext.request.contextPath}/controller/cashier/customerCards/searchBySurname" method="POST">
...
<div class="container-fluid">
    <div class="back-btn-container">
        <form action="${pageContext.request.contextPath}/controller/cashier" method="get">
            <button type="submit" class="back-btn">Back to cashier menu</button>
        </form>
    </div>
</div>
