...
public class SearchCheckByEmployeeIdCommand implements Command {

    private final CheckService checkService;
    private final Customer_cardService customerCardService;
    private final EmployeeService employeeService;

    public SearchCheckByEmployeeIdCommand(CheckService checkService, Customer_cardService customerCardService, EmployeeService employeeService) {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Check> checks = checkService.searchChecksByEmployeeId(id_employee);
