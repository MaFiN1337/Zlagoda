...
public class SearchSumOfChecksPerPeriodCommand implements Command {

    private final CheckService checkService;

    public SearchSumOfChecksPerPeriodCommand(CheckService checkService) {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        Optional<CheckSumDto> sum = checkService.searchSumOfChecksPerPeriod(LocalDate.parse(fromDate), LocalDate.parse(toDate));
