...
public class SearchChecksByEmployeeIdPerPeriodCommand implements Command {

    private final CheckService checkService;
    private final Customer_cardService customerCardService;
    private final EmployeeService employeeService;

    public SearchChecksByEmployeeIdPerPeriodCommand(CheckService checkService, Customer_cardService customerCardService, EmployeeService employeeService) {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        String idEmployee = request.getParameter(Attribute.ID_EMPLOYEE);
        ...
        List<Check> checks = checkService.searchChecksByEmployeeIdPerPeriod(idEmployee, LocalDate.parse(fromDate), LocalDate.parse(toDate));
