...
public class PostUpdateStoreProductCommand implements Command {
    ...
    public PostUpdateStoreProductCommand(Store_productService storeProductService, ProductService productService) {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        storeProductService.updateStore_product(storeProduct);
    ...
    private Store_product getUserInput(HttpServletRequest request) {
        return new Store_product.Builder().setUpc(request.getParameter(Attribute.UPC))
                .setProducts_number(Long.valueOf(request.getParameter(Attribute.PRODUCTS_NUMBER)))
