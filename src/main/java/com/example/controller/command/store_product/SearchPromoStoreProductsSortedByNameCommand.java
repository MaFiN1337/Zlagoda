...
public class SearchPromoStoreProductsSortedByNameCommand implements Command {

    private final Store_productService storeProductService;
    private final ProductService productService;

    public SearchPromoStoreProductsSortedByNameCommand(Store_productService storeProductService, ProductService productService) {
