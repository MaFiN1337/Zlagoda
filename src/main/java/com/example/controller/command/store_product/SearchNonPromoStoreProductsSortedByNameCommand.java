...
public class SearchNonPromoStoreProductsSortedByNameCommand implements Command {

    private final Store_productService storeProductService;
    private final ProductService productService;

    public SearchNonPromoStoreProductsSortedByNameCommand(Store_productService storeProductService, ProductService productService) {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Store_product> storeProducts = storeProductService.searchNonPromotionalStore_productSortedByName();
