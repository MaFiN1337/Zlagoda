...
public class SearchStoreProductsSortedByProductsNumCommand implements Command {

    private final Store_productService storeProductService;
    private final ProductService productService;

    public SearchStoreProductsSortedByProductsNumCommand(Store_productService storeProductService, ProductService productService) {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Store_product> storeProducts = storeProductService.searchStore_productSortedByProductsNum();
