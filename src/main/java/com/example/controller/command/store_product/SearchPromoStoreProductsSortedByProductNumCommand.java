...
public class SearchPromoStoreProductsSortedByProductNumCommand implements Command {

    private final Store_productService storeProductService;
    private final ProductService productService;

    public SearchPromoStoreProductsSortedByProductNumCommand(Store_productService storeProductService, ProductService productService) {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Store_product> storeProducts = storeProductService.searchPromotionalStore_productSortedByProductsNum();
